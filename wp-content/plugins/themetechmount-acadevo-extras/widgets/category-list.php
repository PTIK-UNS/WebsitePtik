 ...
 * @since 1.0
 */
class acadevo_category_list_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_style = array('classname'   => 'acadevo_category_list_widget',
							  'description' => esc_attr__('Show Category List of current Taxonomy.', 'acadevo') );
		parent::__construct(
			'acadevo_category_list_widget', // Base ID
			esc_attr__('Acadevo Category/Group List Widget', 'acadevo'), // Name
			$widget_style // Args
		);
	}
...
register_widget( 'acadevo_category_list_widget' );