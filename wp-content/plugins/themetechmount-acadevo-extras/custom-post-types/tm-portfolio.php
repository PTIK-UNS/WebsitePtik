...
function themetechmount_acadevo_cpt_tm_portfolio(){
	...
	$pf_type_slug           = ( !empty($acadevo_theme_options['pf_type_slug']) ) ? $acadevo_theme_options['pf_type_slug'] : 'portfolio' ;
	...
	$pf_cat_slug           = ( !empty($acadevo_theme_options['pf_cat_slug']) ) ? $acadevo_theme_options['pf_cat_slug'] : 'portfolio-category' ;
...
add_action( 'init', 'themetechmount_acadevo_cpt_tm_portfolio', 8 );
 ...
 */
if ( ! function_exists( 'themetechmount_acadevo_tm_portfolio_metabox_options' ) ) {
function themetechmount_acadevo_tm_portfolio_metabox_options( $options ) {
	...
	$list_array    = array();
	$options_array = array();
	if( isset($acadevo_theme_options['pf_details_line']) && is_array($acadevo_theme_options['pf_details_line']) && count( $acadevo_theme_options['pf_details_line'] ) > 0 ){
		foreach( $acadevo_theme_options['pf_details_line'] as $key=>$val ){
			...
			$option_array = array(
				...
				'type'       => 'text',
				'title'      => '<span class="tm-admin-pf-list-icon"> <i class="'. $icon_class .'"></i></span> &nbsp; '. esc_attr__($val['pf_details_line_title'], 'acadevo'),
			);
	...
	$options[]    = array(
		...
		'title'     => sprintf( esc_attr__('Acadevo: %s List Options', 'tmte'), $pf_type_title_singular ),
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Acadevo: Featured Image / Video / Slider', 'tmte'),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
	...
	$options[]    = array(
		...
		'title'     => sprintf( esc_attr__('Acadevo: %s View Style', 'tmte'), $pf_type_title_singular ),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Acadevo: Portfolio Like Option','tmte'),
		'post_type' => 'tm_portfolio', // only here is important
		'context'   => 'normal',
		'priority'  => 'default',
		'sections'  => array(
...
add_filter( 'cs_metabox_options', 'themetechmount_acadevo_tm_portfolio_metabox_options' );