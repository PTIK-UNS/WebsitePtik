...
function themetechmount_acadevo_cpt_tm_testimonial(){
	...
	function themetechmount_acadevo_tm_testimonial_enter_title_here( $title ){
	...
	add_filter( 'enter_title_here', 'themetechmount_acadevo_tm_testimonial_enter_title_here' );


	// Move Featured Image box from left to center only on CLIENTS custom_post_type
	add_action('do_meta_boxes', 'themetechmount_acadevo_tm_testimonial_featured_image_box');
	function themetechmount_acadevo_tm_testimonial_featured_image_box() {
...
add_action( 'init', 'themetechmount_acadevo_cpt_tm_testimonial', 8 );
 ...
 *  Meta Box: Clients
 */
if ( ! function_exists( 'themetechmount_acadevo_tm_testimonials_metabox_options' ) ) {
function themetechmount_acadevo_tm_testimonials_metabox_options( $options ) {
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Acadevo: Testimonial Details', 'tmte'),
...
add_filter( 'cs_metabox_options', 'themetechmount_acadevo_tm_testimonials_metabox_options' );
