...
/**** Icon Libraries ****/
function themetechmount_acadevo_enqueue_icon_libraries(){
...
add_action( 'wp_enqueue_scripts', 'themetechmount_acadevo_enqueue_icon_libraries' );
 ...
 */
function themetechmount_acadevo_admin_scripts_styles() {
	...
	// iconset-themify
	wp_enqueue_script( 'iconset-kw_acadevo', TMTE_URI . '/vc/themetechmount_iconpicker/iconset-kw_acadevo.js', array( 'bootstrap' ) );
	...
	// iconset-kw_acadevo
	wp_enqueue_style( 'kw_acadevo', get_template_directory_uri().'/assets/themetechmount-acadevo-extra-icons/font/flaticon.css' );
...
add_action( 'admin_enqueue_scripts', 'themetechmount_acadevo_admin_scripts_styles' );
