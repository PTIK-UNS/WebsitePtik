...
class CSFramework_Option_themetechmount_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_attr__( 'Multilingual Acadevo Theme', 'acadevo' );
	$config['name']				= esc_attr( 'Acadevo' ); //name of theme/plugin
	$config['box_description']	= esc_attr__('Acadevo theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'acadevo' );
