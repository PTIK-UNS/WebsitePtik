...
class CSFramework_Option_themetechmount_iconpicker extends CSFramework_Options {
  ...
  public function output(){
	...
	$icon_library_array = array( // all icon library list array
		'themify'        => array( esc_attr__( 'Themify icons', 'acadevo' ), 'ti-location-pin'),
		'linecons'       => array( esc_attr__( 'Linecons', 'acadevo' ),      'li_star'),
	);
	...
	$icon_picker_html    = '';
	$icon_dropdown_array = array( esc_attr__( 'Font Awesome', 'acadevo' )    => 'fontawesome' );
