<?php
/**
 * Acadevo functions and definitions
 *
...
if ( ! function_exists( 'acadevo_setup' ) ) :
/**
...
function acadevo_setup() {
	 ...
	 * If you're building a theme based on acadevo, use a find and replace
	 * to change 'acadevo' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'acadevo', get_template_directory() . '/languages' );
	...
	register_nav_menus( array( // https://codex.wordpress.org/Function_Reference/has_nav_menu
		'tm-main-menu'			=> esc_html__( 'Main Menu', 'acadevo' ),
		'tm-footer-menu'		=> esc_html__( 'Footer Menu', 'acadevo' ),
		'tm-topbar-left-menu'	=> esc_html__( 'Topbar Left Menu', 'acadevo' ),
		'tm-topbar-right-menu'	=> esc_html__( 'Topbar Right Menu', 'acadevo' ),
	) );
	
}
endif; // acadevo_setup()
add_action( 'after_setup_theme', 'acadevo_setup' );
