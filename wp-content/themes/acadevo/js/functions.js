/**
 * Functionality specific to Acadevo.
 *
...
function acadevo_logMarginPadding(){
	/**************/
	jQuery('.wpb_column').each(function(){
		if( jQuery(this).hasClass('tm-left-span') ){
			...
			randomclass     = 'acadevo-random-class-' + randomclass;
...
function acadevo_logMarginPadding_right(){
	/**************/
	jQuery('.wpb_column').each(function(){
...
function acadevo_circle_progress_counter(){
...
jQuery( document ).ready(function($) {
	...
	jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .tm-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='tm-acadevo-icon-angle-down'></i></span>");	
	...
	jQuery('.righticon').on('click', function() {
		if(jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')){
			...
			jQuery( 'i', jQuery(this) ).removeClass('tm-acadevo-icon-angle-up').addClass('tm-acadevo-icon-angle-down');
		} else {
			jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');			
			jQuery( 'i', jQuery(this) ).removeClass('tm-acadevo-icon-angle-down').addClass('tm-acadevo-icon-angle-up');
		}
		return false;
 	});
	...
	acadevo_circle_progress_counter();
	...
	/* Logo Margin Padding
	/*------------------------------------------------------------------------------*/
	acadevo_logMarginPadding();
	acadevo_logMarginPadding_right();
	...
	jQuery( ".tm-header-search-link a" ).on('click', function(){
		...
		if (jQuery('.tm-header-search-link a').hasClass('sclose')) {	
			jQuery( ".tm-header-search-link a i" ).removeClass('tm-acadevo-icon-search').addClass('tm-acadevo-icon-close');
			jQuery(this).removeClass('sclose').addClass('open');	
			jQuery(".tm-search-overlay").addClass('st-show');					
		} else {
			jQuery(this).removeClass('open').addClass('sclose');
			jQuery( ".tm-header-search-link a i" ).removeClass('tm-acadevo-icon-close').addClass('tm-acadevo-icon-search');	
...
jQuery(window).load(function(){
	...
	( function() {
		...
		jQuery( '.menu-toggle' ).on( 'click.acadevo', function() {
