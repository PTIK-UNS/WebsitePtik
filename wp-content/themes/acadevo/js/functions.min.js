...
filterLinks.on('click',function(e){var selector=jQuery(this).attr('data-filter');gallery_item.isotope({filter:selector,itemSelector:'.isotope-item'});filterLinks.removeClass('selected');jQuery('#filter-by li').removeClass('current-cat');jQuery(this).addClass('selected');e.preventDefault()})})};function acadevo_logMarginPadding(){jQuery('.wpb_column').each(function(){if(jQuery(this).hasClass('tm-left-span')){var margin=jQuery(this).parent().css("padding-left").replace("px","");margin=parseInt(margin);var elewidth=jQuery(this).css("width").replace("px","");elewidth=parseInt(elewidth);var leftmargin=margin+elewidth;var after_inlinecss='';var before_inlinecss='';var randomclass=Math.floor((Math.random()*1000000)+1);randomclass='acadevo-random-class-'+randomclass;jQuery(this).addClass(randomclass);after_inlinecss+='padding-left: '+leftmargin+'px;';if(jQuery('.vc_column-inner',this).css('background-image')!='none'){var bgimage=jQuery('.vc_column-inner',this).css('background-image');jQuery('.vc_column-inner',this).css('background-image','none','!important');after_inlinecss+='background-image: '+bgimage+';'}
...
function acadevo_logMarginPadding_right(){jQuery('.wpb_column').each(function(){if(jQuery(this).hasClass('tm-right-span')){var margin=jQuery(this).parent().css("padding-right").replace("px","");margin=parseInt(margin);var elewidth=jQuery(this).css("width").replace("px","");elewidth=parseInt(elewidth);var leftmargin=margin+elewidth;var after_inlinecss='';var before_inlinecss='';var randomclass=Math.floor((Math.random()*1000000)+1);randomclass='acadevo-random-class-'+randomclass;jQuery(this).addClass(randomclass);after_inlinecss+='padding-right: '+leftmargin+'px;';if(jQuery('.vc_column-inner',this).css('background-image')!='none'){var bgimage=jQuery('.vc_column-inner',this).css('background-image');jQuery('.vc_column-inner',this).css('background-image','none','!important');after_inlinecss+='background-image: '+bgimage+';'}
if(jQuery('.vc_column-inner',this).css('background-color')!=''||jQuery('.vc_column-inner',this).css('background-color')!='inherit'){var bgcolor=jQuery('.vc_column-inner',this).css('background-color');before_inlinecss+='background-color: '+bgcolor+';'}
...
function acadevo_circle_progress_counter(){jQuery('.tm-circle-box').each(function(){var circle_box=jQuery(this);var fill_val=circle_box.data('fill');var emptyFill_val=circle_box.data('emptyfill');var thickness_val=circle_box.data('thickness');var fill_gradient=circle_box.data('gradient');var startangle_val=(-Math.PI/4*1.5);if(fill_gradient!=''){fill_gradient=fill_gradient.split('|');fill_val={gradient:[fill_gradient[0],fill_gradient[1]]}}
...
jQuery('.menu-toggle').on('click.acadevo',function(){nav.toggleClass('toggled-on')})})();jQuery('.righticon').each(function(){var mainele=this;if(jQuery(mainele).prev().prev().length>0){if(jQuery(mainele).prev().prev().attr('href')=='#'){jQuery(mainele).prev().prev().on('click',function(){jQuery(mainele).trigger("click")})}}});themetechmount_blogmasonry();jQuery(".themetechmount-fbar-content-wrapper").perfectScrollbar({suppressScrollX:!0,includePadding:!0});jQuery(".tm-header-style-classic-vertical .tm-header-block").perfectScrollbar({suppressScrollX:!0,includePadding:!0})});jQuery(window).resize(function(){"use strict";equalheight('.tm-equalheightdiv  .wpb_column.vc_column_container');setTimeout(function(){jQuery('.tm-timeline').smTimeline()},100);if(jQuery('.themetechmount-testimonial-box').length>0){setHeight('.themetechmount-testimonial-box.col-lg-4.col-sm-6.col-md-4');setHeight('.themetechmount-testimonial-box.col-lg-6.col-sm-6.col-md-6');setHeight('.themetechmount-testimonial-box.col-lg-3.col-sm-6.col-md-3')}
