...
function themetechmount_sticky(){var pageWidth=jQuery(window).width();if(parseInt(pageWidth)>parseInt(tm_breakpoint)){jQuery('.tm-stickable-header').stick_in_parent({'parent':'body','spacer':!1})}else{jQuery('.tm-stickable-header').trigger("sticky_kit:detach")}}
