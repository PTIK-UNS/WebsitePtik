...
$allParams = array_merge(
	...
	array(
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Blogbox Design",'acadevo'),
			"description" => esc_attr__("Select Blogbox design.",'acadevo'),
			"param_name"  => "view",
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Show Posts",'acadevo'),
			"description" => esc_attr__("How many post you want to show.",'acadevo'),
			"param_name"  => "show",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show sortable category links above Blog boxes so user can sort by category by just single click.",'acadevo'),
			"param_name"  => "sortable",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show pagination links below blog boxes.",'acadevo'),
		...
		array(
			"type"        => "checkbox",
			"heading"     => esc_attr__("From Category", "acadevo"),
			"description" => esc_attr__("If you like to show posts from selected category than select the category here.", "acadevo") . esc_attr__("The brecket number shows how many posts there in the category.", "acadevo"),
			"param_name"  => "category",
			"value"       => $catList,
			'group'		  => esc_attr__( 'Box Style', 'acadevo' ),
		),
...
vc_map( array(
	"name"     => esc_attr__('ThemetechMount Blog Box','acadevo'),
	"base"     => "tm-blogbox",
	"class"    => "",
