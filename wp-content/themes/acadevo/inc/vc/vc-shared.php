...
class themetechmount_VcSharedLibrary {
	...
	public static function themetechmount_getColorsDashed() {
		$colors = array(
			...
			esc_attr__( 'Blue', 'acadevo' ) => 'blue',
			esc_attr__( 'Turquoise', 'acadevo' ) => 'turquoise',
			esc_attr__( 'Pink', 'acadevo' ) => 'pink',
			esc_attr__( 'Violet', 'acadevo' ) => 'violet',
			esc_attr__( 'Peacoc', 'acadevo' ) => 'peacoc',
			esc_attr__( 'Chino', 'acadevo' ) => 'chino',
			esc_attr__( 'Mulled Wine', 'acadevo' ) => 'mulled-wine',
			esc_attr__( 'Vista Blue', 'acadevo' ) => 'vista-blue',
			esc_attr__( 'Black', 'acadevo' ) => 'black',
			esc_attr__( 'Grey', 'acadevo' ) => 'grey',
			esc_attr__( 'Orange', 'acadevo' ) => 'orange',
			esc_attr__( 'Sky', 'acadevo' ) => 'sky',
			esc_attr__( 'Green', 'acadevo' ) => 'green',
			esc_attr__( 'Juicy pink', 'acadevo' ) => 'juicy-pink',
			esc_attr__( 'Sandy brown', 'acadevo' ) => 'sandy-brown',
			esc_attr__( 'Purple', 'acadevo' ) => 'purple',
			esc_attr__( 'White', 'acadevo' ) => 'white'
		);
...
$themetechmount_pixel_icons = array(
	array( 'vc_pixel_icon vc_pixel_icon-alert' => esc_attr__( 'Alert', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-info' => esc_attr__( 'Info', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-tick' => esc_attr__( 'Tick', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-explanation' => esc_attr__( 'Explanation', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-address_book' => esc_attr__( 'Address book', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-alarm_clock' => esc_attr__( 'Alarm clock', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-anchor' => esc_attr__( 'Anchor', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-application_image' => esc_attr__( 'Application Image', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-arrow' => esc_attr__( 'Arrow', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-asterisk' => esc_attr__( 'Asterisk', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-hammer' => esc_attr__( 'Hammer', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon' => esc_attr__( 'Balloon', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_buzz' => esc_attr__( 'Balloon Buzz', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_facebook' => esc_attr__( 'Balloon Facebook', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-balloon_twitter' => esc_attr__( 'Balloon Twitter', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-battery' => esc_attr__( 'Battery', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-binocular' => esc_attr__( 'Binocular', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_excel' => esc_attr__( 'Document Excel', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_image' => esc_attr__( 'Document Image', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_music' => esc_attr__( 'Document Music', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_office' => esc_attr__( 'Document Office', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_pdf' => esc_attr__( 'Document PDF', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_powerpoint' => esc_attr__( 'Document Powerpoint', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-document_word' => esc_attr__( 'Document Word', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-bookmark' => esc_attr__( 'Bookmark', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-camcorder' => esc_attr__( 'Camcorder', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-camera' => esc_attr__( 'Camera', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-chart' => esc_attr__( 'Chart', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-chart_pie' => esc_attr__( 'Chart pie', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-clock' => esc_attr__( 'Clock', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-fire' => esc_attr__( 'Fire', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-heart' => esc_attr__( 'Heart', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-mail' => esc_attr__( 'Mail', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-play' => esc_attr__( 'Play', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-shield' => esc_attr__( 'Shield', 'acadevo' ) ),
	array( 'vc_pixel_icon vc_pixel_icon-video' => esc_attr__( 'Video', 'acadevo' ) ),
);
...
function themetechmount_box_params($boxtype=''){
	...
	$boxview = array(
		esc_attr__('Row and Column','acadevo')  => 'default',
		esc_attr__('Carousel effect','acadevo') => 'carousel',
	);
	
	// CSS Animation
	$vc_map_add_css_animation = vc_map_add_css_animation();
	$vc_map_add_css_animation['group'] = esc_attr__( 'Box Design', 'acadevo' );
	
	if( $boxtype=='blog' ){
		// Nothing to do
	}
	if( $boxtype=='testimonial' ){
		$boxview[esc_attr__("Slick Style One Column Carousel", "acadevo") ] = 'slickview';
	}
	...
	$boxOprions = array(
		...
		array(
			"type"        => "dropdown",
			"heading"     => esc_attr__("Column", "acadevo"),
			"param_name"  => "column",
			"description" => esc_attr__("Select column.", "acadevo"),
			"value"       => array(
				esc_attr__("One Column",    "acadevo") => "one",
				esc_attr__("Two Columns",   "acadevo") => "two",
				esc_attr__("Three Columns", "acadevo") => "three",
				esc_attr__("Four Columns",  "acadevo") => "four",
				esc_attr__("Five Columns",  "acadevo") => "five",
				esc_attr__("Six Columns",   "acadevo") => "six",
			),
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Box View",'acadevo'),
			"description" => esc_attr__("Select box view. Show as normal row and column or show with carousel effect.",'acadevo'),
			"param_name"  => "boxview",
			"value"       => $boxview,
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Timeline: Group by', 'acadevo' ),
			'param_name' => 'timeline_groupby',
			'value'      => array(
				esc_attr__( 'Monthly grouping', 'acadevo' ) => 'monthly',
				esc_attr__( 'Yearly grouping', 'acadevo' )  => 'yearly'
			),
			'description' => esc_attr__( 'Timeline: Show timeline view in which group by.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Timeline: Box view', 'acadevo' ),
			'param_name' => 'timeline_boxview',
			'value'      => array(
				esc_attr__( 'Simple view - without featured image', 'acadevo' ) => 'simple',
				esc_attr__( 'Simple view - with featured image', 'acadevo' )    => 'simple_with_fetured',
				esc_attr__( 'Box view', 'acadevo' )                             => 'box',
			),
			'description' => esc_attr__( 'Timeline: Show timeline view in which group by.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
		...
		array(
			'type'        => 'textfield',
			'heading'     => esc_attr__( 'Carousel: Transaction speed', 'acadevo' ),
			'param_name'  => 'carousel_speed',
			'description' => esc_attr__( 'Carousel Effect: Slide/Fade animation speed.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Autoplay', 'acadevo' ),
			'param_name' => 'carousel_autoplay',
			'value'      => array(
				esc_attr__( 'Yes', 'acadevo' ) => '1',
				esc_attr__( 'No', 'acadevo' )  => '0'
			),
			'description' => esc_attr__( 'Carousel Effect: Enable/disable Autoplay', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'        => 'textfield',
			'heading'     => esc_attr__( 'Carousel: autoplaySpeed', 'acadevo' ),
			'param_name'  => 'carousel_autoplayspeed',
			'description' => esc_attr__( 'Carousel Effect: autoplay speed. Inert numbers only. Default value is "4500".', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Loop Item', 'acadevo' ),
			'param_name' => 'carousel_loop',
			'value'      => array(
				esc_attr__( 'No', 'acadevo' )  => '0',
				esc_attr__( 'Yes', 'acadevo' ) => '1',
			),
			'description' => esc_attr__( 'Carousel Effect: Infinite loop sliding.', 'acadevo' ).'<br><strong>'.esc_attr__( 'NOTE:', 'acadevo' ).' </strong> '.esc_attr__( 'If you select NO than the carousel will rewind all and start from 1st item. Also this will work if you enabled "Autoplay".', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: dots', 'acadevo' ),
			...
			'description' => esc_attr__( 'Carousel Effect: Show dots navigation.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Next/Prev Arrows', 'acadevo' ),
			'param_name' => 'carousel_nav',
			'value'      => array(
				esc_attr__('Above Carousel', 'acadevo')       => 'above',
				esc_attr__('below Carousel', 'acadevo')       => 'below',
				esc_attr__('Before / After boxes', 'acadevo') => '1',
				esc_attr__('Hide', 'acadevo')                 => 'hide',
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: centerMode', 'acadevo' ),
			...
			'description' => esc_attr__( 'Enables centered view with partial prev/next slides. Use with odd numbered slidesToShow counts.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'        => 'textfield',
			'heading'     => esc_attr__( 'Carousel: centerPadding', 'acadevo' ),
			'param_name'  => 'carousel_centerpadding',
			'description' => esc_attr__( 'Carousel center effect padding.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: pauseOnFocus', 'acadevo' ),
			'param_name' => 'carousel_pauseonfocus',
			'value'      => array(
				esc_attr__('Yes', 'acadevo') => '1',
				esc_attr__('No', 'acadevo')  => '0',
			),
			'description' => esc_attr__( 'Carousel Effect: Pause Autoplay On Focus.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: pauseOnHover', 'acadevo' ),
			'param_name' => 'carousel_pauseonhover',
			'value'      => array(
				esc_attr__('Yes', 'acadevo') => '1',
				esc_attr__('No', 'acadevo')  => '0',
			),
			'description' => esc_attr__( 'Carousel Effect: Pause on mouse hover.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: slidesToScroll', 'acadevo' ),
			'param_name' => 'carousel_slidestoscroll',
			'value'      => array(
				esc_attr__( '1 Slide', 'acadevo' )        => '1',
				esc_attr__( 'Same as column', 'acadevo' ) => 'column',
			),
			'description' => esc_attr__( '# of slides to scroll.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel' ),
		...
		array(
			'type'       => 'dropdown',
			'heading'    => esc_attr__( 'Carousel: Box transaction effect', 'acadevo' ),
			'param_name' => 'carousel_effecttype',
			'value'      => array(
				esc_attr__( 'Slide', 'acadevo' )  => 'slide',
				esc_attr__( 'fade', 'acadevo' )   => 'fade',
			),
			'description' => esc_attr__( 'Select Fade or Slide effect for carousel.', 'acadevo' ) . '<br><strong>' . esc_attr__( 'NOTE:', 'acadevo' ) . esc_attr__( 'The FADE effect will work with one column view only.', 'acadevo' ) . '</strong>',
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
			'dependency'  => array(
				'element'   => 'boxview',
				'value'     => array( 'carousel', 'slickview','slickview-leftimg','slickview-bottomimg'),
		...
		array(
			...
			'param_name'  => 'el_class',
			'description' => esc_attr__( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'acadevo' ),
			'group'       => esc_attr__( 'Box Design', 'acadevo' ),
		),
	...
	$params = array_merge(
		array(
			array(
				...
				'param_name'  => 'h2',
				'save_always' => true,
				'value'       => esc_attr__( 'Welcome', 'acadevo' ),
		...
		array(
			array(
				...
				'description' => esc_attr__( 'Select text alignment.', 'acadevo' ),
				'std'         => 'left',
			),
		)
	);
...
function themetechmount_vc_ele_css_editor_option(){
	...
	$return = array(
		'type'       => 'css_editor',
		'heading'    => esc_attr__( 'CSS box', 'acadevo' ),
		'param_name' => 'css',
		'group'      => esc_attr__( 'Design Options', 'acadevo' )
	);
...
function themetechmount_responsive_padding_margin_option( $for=''){
	$return = array(
		...
		"heading"		=> esc_attr__("Responsive Screen Padding/Margin Options", "acadevo"),
		"description"	=> esc_attr__("You can manage padding/margin from here. For different screen sizes", "acadevo"),
		"param_name"	=> "tm_responsive_css",
		'group'			=> esc_attr__( 'Responsive Screen Padding/Margin Options', 'acadevo' ),
	);
