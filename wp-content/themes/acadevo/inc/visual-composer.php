...
// tm-processbox
add_action( 'vc_after_init', 'themetechmount_vc_custom_element_processbox' );
function themetechmount_vc_custom_element_processbox(){ get_template_part('inc/vc/element-tm','processbox'); }

// tm-coursebox
add_action( 'vc_after_init', 'themetechmount_vc_custom_element_coursebox' );
function themetechmount_vc_custom_element_coursebox(){ get_template_part('inc/vc/element-tm','coursebox'); }

// tm-hoverbox
add_action( 'vc_after_init', 'themetechmount_vc_custom_element_hoverbox' );
function themetechmount_vc_custom_element_hoverbox(){ get_template_part('inc/vc/element-tm','hoverbox'); }