...
$header_search = ( !isset($acadevo_theme_options['header_search']) ) ? '1' : esc_attr($acadevo_theme_options['header_search']);
...
<div class="header-controls">
	...
	<?php endif; ?>
	<?php
	$wc_header_icon = ( isset($acadevo_theme_options['wc-header-icon']) && trim($acadevo_theme_options['wc-header-icon'])!='' ) ? esc_attr($acadevo_theme_options['wc-header-icon']) : '1' ;
